...
public class Activator implements BundleActivator {
	...
	private volatile static ServiceTracker<Object, Object> _frameworkLogTracker;
	...
	public void start(BundleContext context) throws Exception {
		_frameworkLogTracker = new ServiceTracker<Object, Object>(context,
		...
		Policy.setLog(new ILogger() {
			...
			public void log(IStatus status) {
				ServiceTracker<Object, Object> frameworkLogTracker = _frameworkLogTracker;
