...
public class MasterDetailObservables {
	 ...
	 */
	public static <U, V> IObservableValue<V> detailValue(
			IObservableValue<U> master,
			IObservableFactory<IObservableValue<V>, ? super U> detailFactory,
			Object detailType) {
		return new DetailObservableValue<U, V>(master, detailFactory,
				detailType);
	}
	 ...
	 */
	public static <U, V> IObservableList<V> detailList(
			IObservableValue<U> master,
			IObservableFactory<IObservableList<V>, ? super U> detailFactory,
			Object detailElementType) {
		return new DetailObservableList<U, V>(detailFactory, master,
				detailElementType);
	}
	 ...
	 */
	public static <U, V> IObservableSet<V> detailSet(
			IObservableValue<U> master,
			IObservableFactory<IObservableSet<V>, ? super U> detailFactory,
			Object detailElementType) {
		return new DetailObservableSet<U, V>(detailFactory, master,
				detailElementType);
	}
	 ...
	 * @since 1.1
	 */
	public static <K, V, U> IObservableMap<K, V> detailMap(
			IObservableValue<U> master,
	...
	public static <K, V, U> IObservableMap<K, V> detailMap(
		...
		return new DetailObservableMap<K, V, U>(detailFactory, master,
	 ...
	 * @since 1.4
	 */
	public static <U, V> IObservableList<V> detailValues(IObservableList<U> masterList,
			IObservableFactory<IObservableValue<V>, ? super U> detailFactory, Object detailType) {
		return new ListDetailValueObservableList<U, V>(masterList, detailFactory,
				detailType);
	}
	 ...
	 * @since 1.4
	 */
	public static <U, V> IObservableMap<U, V> detailValues(IObservableSet<U> masterSet,
			IObservableFactory<IObservableValue<V>, ? super U> detailFactory, Object detailType) {
		return new SetDetailValueObservableMap<U, V>(masterSet, detailFactory,
				detailType);
	}
	 ...
	 * @since 1.4
	 */
	public static <K, I, V> IObservableMap<K, V> detailValues(IObservableMap<K, I> masterMap,
			IObservableFactory<IObservableValue<V>, ? super I> detailFactory, Object detailType) {
		return new MapDetailValueObservableMap<K, I, V>(masterMap, detailFactory,
				detailType);
	}
}
