...
public class Observables {
	 ...
	 */
	public static <T> IObservableList<T> emptyObservableList() {
	 ...
	 * @since 1.1
	 */
	public static <T> IObservableList<T> emptyObservableList(Object elementType) {
	 ...
	 * @return an empty observable list.
	 */
	public static <T> IObservableList<T> emptyObservableList(Realm realm) {
	...
	public static <T> IObservableList<T> emptyObservableList(Realm realm,
			Object elementType) {
		return new EmptyObservableList<T>(realm, elementType);
	}
	 ...
	 * @since 1.1
	 */
	public static <K, V> IObservableFactory<IObservableValue<V>, K> mapEntryValueFactory(
			final IObservableMap<K, V> map, final Object valueType) {
		return new IObservableFactory<IObservableValue<V>, K>() {
